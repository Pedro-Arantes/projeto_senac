      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="../listarconsultasprof.php">Listar Consulta</a></li>
          </ul>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="../listarservicoprof.php">Listar Serviço</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="../frmservicoprof.php">Serviço</a></li>
...
<div class="border rounded border-success border-5 container">
    ...
    <a class="btn btn-info" href="../listarpacienteprof.php">Listar Pacientes</a>
    <p>Ou deseja adicionar um novo?</p>
    <a class="btn btn-info" href="../frmpacienteprof.php">Cadastrar Paciente</a>
    <hr>
