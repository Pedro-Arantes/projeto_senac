...
<hr>
<a class="btn btn-outline-success" href="frmreserva1.php">Nova Reserva</a>
...
<table class="table table-dark table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a class="btn btn-outline-warning" href="frmreserva1.php?idreserva=<?php echo $reserva->idreserva ?>">Editar</a></td>
            <td><a class="btn btn-outline-danger" href="frmreserva1.php?op=del&idreserva=<?php echo  $reserva->idreserva ?>">Excluir</a></td>
