...
<table class="table table-dark table-striped ">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a class="btn btn-outline-warning" href="frmpaciente.php?idpaciente=<?php echo $paciente->idpaciente ?>">Editar</a></td>
            <td><a  class="btn btn-outline-danger" href="frmpaciente.php?op=del&idpaciente=<?php echo  $paciente->idpaciente ?>">Excluir</a></td>
