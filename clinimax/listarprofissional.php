...
<table class="table table-dark table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a class="btn btn-outline-warning" href="frmprof.php?idprof=<?php echo $prof->idprof ?>">Editar</a></td>
            <td><a class="btn btn-outline-danger" href="frmprof.php?op=del&idprof=<?php echo  $prof->idprof ?>">Excluir</a></td>
